...
namespace ILGPU.IR.Values
{
    ...
    public sealed class UnaryArithmeticValue : ArithmeticValue
    {
        ...
        protected override TypeNode ComputeType(in ValueInitializer initializer)
        {
            ...
            return type ?? initializer.Context.VoidType;
        }
    ...
    public sealed class BinaryArithmeticValue : ArithmeticValue
    {
        ...
        internal BinaryArithmeticValue(
            ...
            : base(initializer, flags)
        {
            bool isLeftPointer = left.Type?.IsPointerType ?? false;
            bool isRightPointer = right.Type?.IsPointerType ?? false;
            initializer.Assert(
        ...
        /// <summary cref="Value.ComputeType(in ValueInitializer)"/>
        protected override TypeNode ComputeType(in ValueInitializer initializer) =>
            Left.Type ?? initializer.Context.VoidType;
    ...
    public sealed class TernaryArithmeticValue : ArithmeticValue
    {
        ...
        /// <summary cref="Value.ComputeType(in ValueInitializer)"/>
        protected override TypeNode ComputeType(in ValueInitializer initializer) =>
            First.Type ?? initializer.Context.VoidType;
