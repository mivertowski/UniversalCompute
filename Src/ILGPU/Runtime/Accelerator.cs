...
namespace ILGPU.Runtime
{
    ...
    public enum AcceleratorType : int
    {
        ...
        /// <summary>
        /// Represents an Apple Metal accelerator for Apple Silicon.
        /// </summary>
        Metal,

        /// <summary>
        /// Represents an Intel OneAPI accelerator.
        /// </summary>
        OneAPI,

        /// <summary>
        /// Represents an AMD ROCm accelerator.
        /// </summary>
        ROCm,

        /// <summary>
        /// Represents Intel AMX (Advanced Matrix Extensions) accelerator.
        /// </summary>
        IntelAMX,

        /// <summary>
        /// Represents Apple Neural Engine accelerator.
        /// </summary>
        AppleNeuralEngine,

        /// <summary>
        /// Represents a Vulkan compute accelerator.
        /// </summary>
        Vulkan,

        /// <summary>
        /// Represents Intel NPU (Neural Processing Unit) for AI acceleration.
        /// </summary>
        IntelNPU,
    }
